...
import (
	...
	"strconv"
	"time"
	"wshop_srvs/goods_srv/global"
	"wshop_srvs/goods_srv/model"
)
...
func main() {
	// dsn := "root:123456@tcp(192.168.0.249:3306)/wshop_goods_srv?charset=utf8mb4&parseTime=True&loc=Local"
	//
...
func Mysql2Es() {
	...
	host := "http://192.168.0.249:9200"
	logger := log.New(os.Stdout, "wshop", log.LstdFlags)
